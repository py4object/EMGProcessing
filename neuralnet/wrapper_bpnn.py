...
close2 = np.loadtxt(fname="test/close2.txtfq")
open2 = np.loadtxt(fname="test/open2.txtfq")
open3 = np.loadtxt(fname="test/open3.txtfq")

begin, end, step = 0, 88, 5
c2 = close2[begin:end:step]
o2 = open2[begin:end:step]
